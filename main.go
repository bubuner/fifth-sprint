...
func (r Running) Calories() float64 {
	return ((18*r.Training.meanSpeed() + 1.79) * r.Training.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(w.Training.meanSpeed(), 2)/w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
}
